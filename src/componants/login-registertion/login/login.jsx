                    ...
                    <div className="half-s">
                        ...
                        <form onSubmit={(e) => handleSubmit(e)} className="login-form">
                            <div className="side-line">
                                ...
                                <input type='text' className="form-email" id="username" value={data.username} onChange={(e) => { handleChange(e) }} placeholder="Mobile / Email" />
                                <input type={hide?"password":"text"} className="form-pwd" id="password" value={data.password} onChange={(e) => { handleChange(e) }} placeholder="Password" />
